<div class="right_col" role="main">
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group btn-breadcrumb">
                ...
                <a href="<?php echo base_url(); ?>bricks/debit_report" class="btn btn-success">Debit Report</a>
            </div>    
        </div>
    </div>
    <br/>
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_content">
                    <form action="<?php echo base_url(); ?>bricks/search_debit_report" method="POST" class="form-horizontal form-label-left" novalidate>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <button id="send" type="submit" class="btn btn-danger">See Debit Report</button>
                            </div>
                        </div>
                    </form>
                </div>
