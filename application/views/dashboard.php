<script>
    function calculating()
    {
        ...
        document.getElementById('total').value = (unitPrice * 1) * (quantity * 1) - (discount * 1);
    }
</script>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-5">
            <div class="offer offer-primary">
                ...
                <div class="offer-content">
                    <h3 class="lead">
                        <label class="label label-primary"><?php echo $current_balance->cashbook_balance; ?></label>
                    </h3>
                    <p>Current Balance</p>
                </div>
            </div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="offer offer-danger">
                ...
                <div class="offer-content">
                    <h3 class="lead">
                        <label class="label label-danger"><?php echo $all_customer_due->customer_due; ?></label>
                    </h3>
                    <p>Customer Due</p>
                </div>
            </div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="offer offer-success">
                ...
                <div class="offer-content">
                    <h3 class="lead">
                        <label class="label label-success"><?php echo $all_contractor_due->contractor_due; ?></label>
                    </h3>
                    <p>Contractor Due</p>
                </div>
            </div>
            ...
            <form action="<?php echo base_url(); ?>bricks/save_sale" method="POST" class="form-horizontal form-label-left" novalidate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="item form-group">
                            <button id="send" type="submit" class="btn btn-dark pull-right">Execute Sale</button>
                        </div>
                    </div>
                </div>
            </form>
