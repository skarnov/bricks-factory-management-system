    ...
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group btn-breadcrumb">
                ...
                <a href="<?php echo base_url(); ?>bricks/add_credit" class="btn btn-info">Add Credit</a>
                <a href="<?php echo base_url(); ?>bricks/manage_credit" class="btn btn-success">Manage Credit</a>
            </div>
        </div>
    </div>
    <br/>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <h3 style="color:green">
                    <?php
                    $msg = $this->session->userdata('save_credit');
                    if (isset($msg)) {
                        echo $msg;
                        $this->session->unset_userdata('save_credit');
                    }
                    ?>
                </h3>
                <div class="x_content">
                    <form action="<?php echo base_url(); ?>bricks/save_credit" method="POST" class="form-horizontal form-label-left" novalidate>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Category</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="credit_category_name" class="form-control">
                                    <option>Choose Category</option>
                                    <?php foreach ($all_credit_category as $v_credit_category) { ?>
                                        <option value="<?php echo $v_credit_category->credit_category_name; ?>"><?php echo $v_credit_category->credit_category_name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
