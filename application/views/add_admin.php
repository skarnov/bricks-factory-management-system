<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add New Admin <small>Create New Administrator</small></h2>
                ...
                <?php if (validation_errors() != NULL) { ?>
                    <div style="background-color:red; padding: 1%; color:white;"><?php echo validation_errors(); ?></div><br/>
                <?php } ?>
                ...
                <div class="x_content">
                    <form action="<?php echo base_url(); ?>bricks/save_admin" method="POST" class="form-horizontal form-label-left" novalidate>
                        ...
                        <input type="hidden" name="time" value="<?php echo date("F j, Y l") . date(' h:i A', strtotime('+4 hour')); ?>" class="form-control col-md-7 col-xs-12">
                        <div class="item form-group">
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Status <span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
