...
<html>
    ...
    <body>
        <div>
            <center>
                <h3 style="margin:0; text-align: center">Total Debit Report</h3>
                <p style="margin:0; text-align: center">Total Debit : <b><?php echo $total_debit->total; ?></b></p>
                <br/>
                <br/>
                    ...
                    <tbody>
                        ...
                        foreach ($debit_report_info as $v_cashbook) {
                            ...
                            <tr>
                                ...
                                <td style="border:1px solid black;"><?php echo $v_cashbook->cashbook_debit; ?></td>
                            </tr>
                            <?php
                        }
                        ?>
