<script>
    ...
    function getState(val)
    {
        if (val !== 'null')
        {
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>bricks/employee_due/' + val,
...
<div class="right_col" role="main">
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group btn-breadcrumb">
                ...
                <a href="<?php echo base_url(); ?>bricks/add_salary" class="btn btn-info">Add New Salary</a>
                <a href="<?php echo base_url(); ?>bricks/manage_salary" class="btn btn-success">Manage Salaries</a>
            </div>
        </div>
    </div>
    <br/>
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add New Salary <small>New Employee Salary</small></h2>
                ...
                <div class="x_content">
                    <form action="<?php echo base_url(); ?>bricks/save_salary" method="POST" class="form-horizontal form-label-left" novalidate>
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Employee</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="employee_id" id="employee_id" onmouseout="getState(this.value);" class="form-control">
                            ...
                            <div class="col-md-5">
                                <div class="item form-group">
                                    <label class="control-label col-md-5 col-sm-5 col-xs-12">Previous Due Amount</label>
